...
ggplot(pred_data, aes(x = civil_society_strength, y = predicted_polyarchy,
  ...
  labs(
    ...
    caption = "Note: Shows how the effect of civil society strength weakens when past repression increases. /nUpward trend indicates positive and strong relationship between civil society strength and electoral democracy, /ngradient from darker to ligher indicates effect weakens as repression increases"
  ) +
  theme_classic() +
  theme(
