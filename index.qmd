...
# Filtering countries that are high on civil society but low on electoral democracy
...
ggplot(data = average_indices) + # Invoke ggplot to use geom_point for visualization
  ...
  labs(
    ...
    caption = "Note: Indicates a strong and positive relationship between the VDem civil society index and
electoral democracy"
  ) +
...
modelsummary(
  ...
  gof_omit = 'AIC|BIC|Log.Lik|F|RMSE' ## Omit unnecessary statistics
)
```
...
ggplot(pred_data, aes(x = civil_society_strength, y = predicted_polyarchy,
  ...
  labs(
    ...
    caption = "Note: Upward Trend indicates strong/positive relationship between democracy and civil society strength
Gradient from dark to light indicates repression weakens the effect"
  ) +
  theme_classic() +
  theme(
